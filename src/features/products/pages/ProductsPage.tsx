...
import type { BrandHttp, CategoryHttp } from '@/types/catalog';
import type { ProductListItem } from '@/types/product';

const EMPTY_PRODUCTS: ProductListItem[] = [];
const EMPTY_CATEGORIES: CategoryHttp[] = [];
const EMPTY_BRANDS: BrandHttp[] = [];
...
function ProductsPage() {
  ...
  const handleAttributeValueToggle = (attributeValueId: string) => {
