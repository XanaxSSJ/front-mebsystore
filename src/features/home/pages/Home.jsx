      ...
      <main className="flex-1 w-full">
                ...
                <div className="relative bg-white p-4 rounded-3xl shadow-2xl overflow-hidden">
                  <div className="aspect-[4/5] bg-background-light rounded-2xl overflow-hidden">
                    <img
                      ...
                      alt="High-end fashion model wearing minimalist clothing"
        ...
        {!searchQuery && (
          <section className="w-full relative group pb-12">
            <div className="carousel-container flex overflow-x-auto w-full h-[600px]">
              <div className="carousel-item relative h-full">
                <img alt="Sustainable Fashion Lifestyle" className="w-full h-full object-cover"
                  src="https://lh3.googleusercontent.com/aida-public/AB6AXuBw78qG7FFw9BYw30pHtTqHLiIIu1syYf6n4uxR8IF8RdrNvKQ_lsIJyNz2dU51PDecfRJAeubJ2TawjYdA-yVIfvHx6bjg3v6RdEwZoDKqzBUkxXsLCVJNTCyW2ken-0_9IkVmiYUp_qrrbtkdDEASIx3f6zPqKiGpOYM7lSSLUSMuXsV6FcNi3TO1H-vLMvvJe4W0mOGS_EDFBUM5K0ogDMURxtA-LGaeB_2jmFMBSA3vHNhq8x9ry8jELgfBEvx7wIWageE0wC4" />
                <div
                  className="absolute inset-0 bg-black/20 flex flex-col items-center justify-center text-center px-6">
                  <h2 className="text-white text-5xl md:text-7xl font-black mb-6 tracking-tight drop-shadow-lg">
                    Elevated Daily Life</h2>
                  <p className="text-white/90 text-lg md:text-xl max-w-xl mb-8 font-medium">Discover our commitment to
                    sustainable elegance and timeless craftsmanship.</p>
                  <Link className="bg-white/10 backdrop-blur-md border border-white/30 text-white px-10 py-4 rounded-full font-bold text-sm uppercase tracking-widest hover:bg-white hover:text-surface transition-all duration-300"
                    href="/productos">Shop Now</Link>
                </div>
              </div>
              <div className="carousel-item relative h-full">
                <img alt="Minimalist Apparel Ads" className="w-full h-full object-cover"
                  src="https://lh3.googleusercontent.com/aida-public/AB6AXuCZmm2t6UQDicxArVda4tNwrEvXy8kaIPja8Dr4LkuO_C7svtU23UOdTHKCuXKBlEADHbZ1Lt-vN1W3uWtSUF05IZguqxXVmL6me0zmlNIqMBpK9q-0LNw16mFJvRXozC_t_aC2CoDpiLXqGqX6c1TFwg0U7GqreyTSoo8h5sTbjwsJas1ocU_w-7W_vg2rQCYE8qaHg2NBzi41ySykBjCs-SipciKB3nzD7nxRD_AiS9XgU4LbhJscQ4Kj0-QP_EHhWdg2e2TzolI" />
                <div
                  className="absolute inset-0 bg-black/30 flex flex-col items-center justify-center text-center px-6">
                  <h2 className="text-white text-5xl md:text-7xl font-black mb-6 tracking-tight drop-shadow-lg">Winter
                    Solstice</h2>
                  <p className="text-white/90 text-lg md:text-xl max-w-xl mb-8 font-medium">The palette of the season:
                    Warm earth tones and luxurious textures.</p>
                  <Link className="bg-white/10 backdrop-blur-md border border-white/30 text-white px-10 py-4 rounded-full font-bold text-sm uppercase tracking-widest hover:bg-white hover:text-surface transition-all duration-300"
                    href="/productos">Shop Now</Link>
                </div>
              </div>
              <div className="carousel-item relative h-full">
                <img alt="Premium Outerwear" className="w-full h-full object-cover"
                  src="https://lh3.googleusercontent.com/aida-public/AB6AXuBiF2JZEBbenWd2VGAxt8-qREfmVrmeBQD0MN27eSRh8BIleXwC0woTywZoygpvJpjA-SiKmwCM4t5m-7HXHUVv66dElbuMnwR68f614VQA5vkc6OlLu4tJ8pRwXihxnby9LxspfXpMr2dKVjVlM0hIFpU7RtDin2SUeBvSlMLrxNrzRnYAWZxnhfQaJ6p2eMD64LWEMVpaM2B8YdWdkcAhY_DwIdLREny5p22etVqy5Mn4kaT_ij2F1nVtyhQINHhDOuVfGz2IGpg" />
                <div
                  className="absolute inset-0 bg-black/25 flex flex-col items-center justify-center text-center px-6">
                  <h2 className="text-white text-5xl md:text-7xl font-black mb-6 tracking-tight drop-shadow-lg">
                    Conscious Luxury</h2>
                  <p className="text-white/90 text-lg md:text-xl max-w-xl mb-8 font-medium">Ethically sourced
                    materials designed to last a lifetime.</p>
                  <Link className="bg-white/10 backdrop-blur-md border border-white/30 text-white px-10 py-4 rounded-full font-bold text-sm uppercase tracking-widest hover:bg-white hover:text-surface transition-all duration-300"
                    href="/productos">Shop Now</Link>
                </div>
              </div>
            ...
            <button
              className="absolute left-8 top-1/2 -translate-y-1/2 w-12 h-12 flex items-center justify-center rounded-full border border-white/30 text-white hover:bg-white hover:text-surface transition-all duration-300 opacity-0 group-hover:opacity-100 z-20">
              <span className="material-symbols-outlined">chevron_left</span>
            </button>
            <button
              className="absolute right-8 top-1/2 -translate-y-1/2 w-12 h-12 flex items-center justify-center rounded-full border border-white/30 text-white hover:bg-white hover:text-surface transition-all duration-300 opacity-0 group-hover:opacity-100 z-20">
              <span className="material-symbols-outlined">chevron_right</span>
            </button>

            <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex gap-3 z-20">
              <button className="w-2 h-2 rounded-full bg-white"></button>
              <button className="w-2 h-2 rounded-full bg-white/40 hover:bg-white/70 transition-colors"></button>
              <button className="w-2 h-2 rounded-full bg-white/40 hover:bg-white/70 transition-colors"></button>
            </div>
          </section>
        )}
