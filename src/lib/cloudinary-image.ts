...
export const IMAGE_PRESETS = {
  thumb: { width: 120, crop: "limit" as const },
  cart: { width: 160, crop: "limit" as const },
  card: { width: 480, crop: "limit" as const },
  galleryThumb: { width: 200, crop: "limit" as const },
  galleryMain: { width: 1200, crop: "limit" as const },
  checkout: { width: 120, crop: "limit" as const },
  order: { width: 160, crop: "limit" as const },
  adminThumb: { width: 112, crop: "limit" as const },
  brandLogo: { width: 128, crop: "limit" as const },
} as const;
...
export function getOptimizedImageUrl(
  ...
  delete (merged as TransformOptions).preset;
